...
- **Branding**: Carolina blue (`#7BAFD4`), shield motif, cross icon. `public/brand/baseball-shield.svg` is the page-icon placeholder; `public/brand/baseball/413-shield-logo.jpg` is an AI-generated shield placeholder until the owner supplies the real icon file.
