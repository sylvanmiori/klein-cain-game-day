...
- **Branding**: Carolina blue (`#7BAFD4`), shield motif, cross icon. The official shield logo ships as transparent PNGs in `public/brand/baseball/` (`413-shield-48/96/192/512.png` + full-res `413-shield-logo.png`), generated from the logo file Steven Morris supplied; `app/baseball/icon.png` (64px) and `app/baseball/apple-icon.png` (180px) are the favicon. The old `public/brand/baseball-shield.svg` placeholder is retired.
