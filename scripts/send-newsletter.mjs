...
await transport.sendMail({
  ...
  text:`Tonight: Klein Cain vs ${edition.opponent}, ${edition.kickoff} at ${edition.venue}. Read the game-day briefing: ${url}`,
  html:`<div style="font-family:Helvetica,Arial,sans-serif;max-width:560px;padding:28px;color:#151515"><p style="font-size:11px;font-weight:700;letter-spacing:.12em;color:#612694">CAIN GAME DAY · ISSUE ${edition.issue}</p><h1 style="font-size:28px;line-height:1.1">Klein Cain vs ${edition.opponent}</h1><p>${edition.kickoff} · ${edition.venue}</p><p style="margin:28px 0"><a href="${url}" style="background:#612694;color:white;text-decoration:none;padding:13px 18px;font-weight:700">Read the briefing</a></p></div>`
});
