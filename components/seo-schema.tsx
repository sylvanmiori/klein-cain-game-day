    ...
    '@graph': [
      {
        ...
        alternateName: publication.brand,
      ...
      },
      {
        ...
        sameAs: [
          'https://www.kleincainathletics.com/sport/football/boys/',
          'https://www.maxpreps.com/tx/houston/klein-cain-hurricanes/football/',
        ],
        sport: 'American Football',
        gender: 'Male',
        url: 'https://www.kleincainathletics.com/sport/football/boys/',
        coach: {
          '@type': 'Person',
          name: 'James Clancy',
