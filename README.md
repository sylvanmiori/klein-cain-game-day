...
Between games, the homepage keeps the latest Final and its verified recap. On the first scheduled automation run on the Monday of the next game's week, it switches to that game's Preview; game day therefore always opens on the current matchup and live card.
