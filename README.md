...
The in-season data pipeline runs unattended in GitHub Actions for deterministic facts. A scheduled workflow creates missing editions, promotes the current game, refreshes facts from public sources (scores, records, ranks, predictions, weather) and writes a postgame recap.
